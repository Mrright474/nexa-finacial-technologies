        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <Link to="/dashboard" className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-lg overflow-hidden transition-all duration-300 hover:drop-shadow-[0_0_8px_hsl(var(--primary)/0.6)]">
                <img src={nexaLogo} alt="NEXA" className="w-full h-full object-cover" width={32} height={32} />
              </div>
